...
const { getRandomArticleSlug } = useArticles();
...
// 通知相关
const { unreadCount, clearNotifications, startPolling, stopPolling } = useNotifications();
...
<template>
  <div class="nav-button">
    ...
    <button class="brighten theme-toggle" aria-label="切换主题" @click="toggleDarkMode">
