...
import type { MomentMusic, MusicTrack, LyricLine } from '@@/types/moment';

const { fetchTracks, fetchLyrics, parseLyrics } = useMusic();
...
const metingApi = computed(() => getBasic('meting_api', 'https://meting.flec.top/api'));
...
const audioList = ref<MusicTrack[]>([]);
...
const fetchMusicData = async () => {
  try {
    ...
    audioList.value = await fetchTracks(metingApi.value, { server, type, id });
