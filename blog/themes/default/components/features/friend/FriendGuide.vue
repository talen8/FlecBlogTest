...
const { applyFriend } = useFriendList();
...
const contactEmail = computed(() => getString('author_email'));
const requestURL = useRequestURL();

const siteConfig = computed(() => ({
  name: basicConfig.value.title,
  link: requestURL.origin,
  avatar: basicConfig.value.favicon,
  description: getString('slogan'),
  screenshot: getString('screenshot'),
}));
