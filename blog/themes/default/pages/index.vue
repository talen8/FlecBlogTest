...
const homeLayout = computed(() => getString('home_layout', 'waterfall'));
...
await useSSR('articles-list', { page_size: 20 });
articles.value = articles.value.slice(0, 10);
...
useSeoMeta({
  title: '首页',
  description: () => getBasic('description', '欢迎来到我的博客，分享技术、生活与思考的个人空间'),
});
</script>
